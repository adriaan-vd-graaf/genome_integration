...
def do_gcta_conditional_of_snps(bfile_prepend, ma_file, snp_file_name, out_prepend, gc=1.0):
    """
        Doeas GCTA COJO stepwise selection (no joint effects)
    ...
    tmp_cojo = CojoCmaFile(out_prepend + ".cma.cojo", out_prepend)
