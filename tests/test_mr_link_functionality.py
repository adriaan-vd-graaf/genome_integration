...
def test_mr_link_results_no_causal_effect_with_region():
    ...
    subprocess.run( #this example should run correctly
        ['python3', f'{mr_link_path}/MRlink.py',
         ...
         "--p_val_iv_selection_threshold", "5e-8",
         "--output_file", output_file,
         "--region", '2:100000000-105000000'], check=True
    )

    correct_header = "ensembl_name\tmethod\tbeta\tse\tp_value\tn_ivs\tiv_summary\n"
    reference_result = '2:100000000-105000000\tMR-link_uncalibrated\t0.00881\t0.10919\t9.357e-01\t3\trs58572539;C;-0.40920;0.02737;0.163,rs77150110;A;0.46071;0.05314;0.037,rs6543124;A;-0.26136;0.02076;0.384\n'
...
test_mr_link_results_no_causal_effect_with_region()
